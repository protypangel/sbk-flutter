...
typedef SwapAnimation = material.Key? Function(int boucle, double pourcentage, material.Offset position);
typedef PainterStatic = void Function(material.Canvas canvas, material.Size size);
typedef PainterAnimation = void Function(int boucle, double pourcentage, material.Canvas canvas, material.Size size);
